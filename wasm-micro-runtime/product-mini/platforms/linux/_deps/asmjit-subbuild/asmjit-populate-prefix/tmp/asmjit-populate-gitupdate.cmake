...
execute_process(
  COMMAND "/usr/bin/git" show-ref "c1019f1642a588107148f64ba54584b0ae3ec8d1"
  WORKING_DIRECTORY "/home/grad/wamr/wasm-micro-runtime/product-mini/platforms/linux/_deps/asmjit-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "c1019f1642a588107148f64ba54584b0ae3ec8d1")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("c1019f1642a588107148f64ba54584b0ae3ec8d1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/c1019f1642a588107148f64ba54584b0ae3ec8d1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/grad/wamr/wasm-micro-runtime/product-mini/platforms/linux/_deps/asmjit-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/grad/wamr/wasm-micro-runtime/product-mini/platforms/linux/_deps/asmjit-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
