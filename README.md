...
| 이름     | 학과            | 학번        | 연락처            | 역할 분담                                    |
|----------|-----------------|-------------|-------------------|----------------------------------------------|
| 정윤서   | 정보컴퓨터공학부 | 202155603   | 216yoon@naver.com | - V8 엔진에서의 pkey 할당 매커니즘 분석
- 메모리 권한 관리를 위한 알고리즘 삽입 지점 탐색
- Intel에서 미리 예약해서 사용하는 pkey 값 확인
- offset 값 랜덤으로 생성해서 더하는 코드 작성
- wamr Benchmark(CoreMark) 및 microbenchmark 수행                                             |
